 ...
 */
export function deterministicEventId(provider: string, type: string, rawHash: string): string {
 ...
 */
export function deterministicCommandId(type: string, sourceEventIds: string[]): string {
