...
import type { ReadabilityOrchestrator } from '../readability/readability_orchestrator.js';
...
export interface RegisterReadabilityRoutesOptions {
  orchestrator: ReadabilityOrchestrator;
}

export function registerReadabilityRoutes(
  app: FastifyInstance,
  opts: RegisterReadabilityRoutesOptions,
): void {
