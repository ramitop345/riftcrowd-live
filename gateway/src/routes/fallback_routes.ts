...
import type { FallbackOrchestrator } from '../fallback/fallback_orchestrator.js';
import type { FallbackReason } from '../fallback/fallback_orchestrator.js';
import { z } from 'zod';
...
export interface RegisterFallbackRoutesOptions {
  orchestrator: FallbackOrchestrator;
}

export function registerFallbackRoutes(
  app: FastifyInstance,
  opts: RegisterFallbackRoutesOptions,
): void {
  ...
  app.post('/fallback/activate', (request, reply) => {
    ...
    const reason = parseResult.data.reason as FallbackReason;
