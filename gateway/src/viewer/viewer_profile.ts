...
export function sanitizeDisplayName(
  raw: unknown,
  maxLength: number = DEFAULT_DISPLAY_NAME_MAX_LENGTH,
): string {
  try {
...
export type ContributionCategories = z.infer<typeof ContributionCategoriesSchema>;
...
export function createViewerProfile(
  ...
  displayNameMaxLength: number = DEFAULT_DISPLAY_NAME_MAX_LENGTH,
): ViewerProfile {
