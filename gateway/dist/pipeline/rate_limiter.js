...
class TokenBucketLimiter {
    ...
    _burst; // max tokens
    maxBuckets;
    constructor(rate, burst, maxBuckets = 50_000) {
        this._rate = rate;
        this._burst = burst;
...
export class RateLimiter {
    ...
    _rateLimitBurst;
    _rateLimitGlobal;
    constructor(rateLimitPerViewer = 10, rateLimitBurst = 50, rateLimitGlobal = 1000, maxViewerBuckets = 50_000) {
